...
function Task({ state: { taskName, category, endDate, steps, _id }, index }) {
              ...
              >
                <g opacity="0.5">
                  <path
                    ...
                    fill={selectedButton === "dark" ? "white" : "#292B31"}
                  />
                </g>
              </svg>
              Progress
            </a>
            <p className="dark:text-[#FFFFFF]">{steps ? steps : 1}</p>
          </div>
                ...
                >
                  <g opacity="0.5">
                    <path
                      ...
                      fill={selectedButton === "dark" ? "#FFFFFF" : "#1C1D22"}
                    />
                  </g>
                </svg>
                7
